...
吾有一術。名之曰「載文」。是術曰。
  ...
  吾有二物。曰「Buffer.alloc(0)」。曰「Buffer.alloc(1)」。名之曰「器」。曰「子器」。
  吾有一數。名之曰「器容」。

  恆為是。
    施「(b=>fs.readSync(0,b,0,1))」於「子器」。
    若其等於零者。
      昔之「載畢」者。今陽是矣。
      乃止也。
    ...
    云云。
    施「(d=>s=>x=>d.set(s,x))」於「器」。於「子器」。於「器容」。
  ...
  若「器容」不等於零者。
    施「(b=>l=>b.subarray(0,l).toString())」於「器」於「器容」。加其於「文」。昔之「文」者。今其是矣。
  云云。
是謂「載文」之術也。
