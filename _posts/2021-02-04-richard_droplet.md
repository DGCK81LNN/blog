...
<h1><img src="{% link assets/droplet_banner.png %}" class="w-100" alt="神奇的水滴石"></h1>
...
<figure>
    <img src="{% link assets/droplet_cover.png %}" alt="一张像素画，画中有一个女学生手拿一块水滴形状的透明石头，从教室门往里看，教室里有一个男生正掀开窗帘望向窗外" title="封面">
